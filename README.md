...
La aplicación está en Docker Hub, para ejecutarla en un contenedor de docker. La ubicación de la imágen está disponible [Aquí](https://hub.docker.com/repository/docker/nicolassarmiento8/json-place-holder-exam/general).
